...
**Calcul d’indicateurs pour l’écosystème
...
et de formules R. Supporte le calcul global ou **désagrégé par groupe**
(région, sexe, etc.) — un seul indicateur global peut masquer des écarts
réels que la désagrégation révèle.
...
MIT — voir
[`LICENSE`](https://aristarquepeniel40-lab.github.io/meindicator/LICENSE).
